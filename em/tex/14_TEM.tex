\section{Auswertung der  TEM-Aufnahmen}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.55\textwidth]{img/TEM/2_astrocyte_house_keeper.jpg}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.465\textwidth}
        \centering
        \includegraphics[width=1.1\textwidth]{img/TEM/2_astrocyte_nucleus_cytoplasm.jpg}
    ...
    \begin{subfigure}{0.465\textwidth}
        \centering
        \includegraphics[width=1.1\textwidth]{img/TEM/4_astrocate_Golgi.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{img/TEM/9_heart_muscle.jpg}
